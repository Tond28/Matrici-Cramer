...
main.fill(WHITE)
matrice2x2=blit_button(10, 10, 150, 60, RED)
matrice3x3=blit_button(10, 100, 150, 60, RED)
metodo2x2=blit_button(200, 10, 150, 60, RED)
metodo3x3=blit_button(200, 100, 150, 60, RED)
scritta(35, "Mat. 2x2", BLACK, 10, 23)
scritta(35, "Mat. 3x3", BLACK, 10, 113)
scritta(32, "Cramer", BLACK, 202, 10)
scritta(32, "2x2", BLACK, 240, 40)
scritta(32, "Cramer", BLACK, 202, 100)
scritta(32, "3x3", BLACK, 240, 130)
pygame.display.set_caption("Matrici e metodo di Cramer")
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if matrice2x2.collidepoint(mouse_pos):
                root=Tk()
                ...
                Button(root, text="CALCOLA", command=matrice_2x2, font=('verdana', 15)).place(height=25, x=0, y=300)

                Button(root, text="RESET", command=reset_matrice_2x2, font=('verdana', 15)).place(height=25, x=150, y=300)

                root.bind('<Return>', matrice_2x2)
                root.bind('<Return>', reset_matrice_2x2)

                root.mainloop()

            if matrice3x3.collidepoint(mouse_pos):
                root=Tk()
                ...
                Button(root, text="RESET", command=reset_matrice_3x3, font=('verdana', 15)).place(height=25, x=200, y=400)

                root.bind('<Return>', matrice_3x3)
                root.bind('<Return>', reset_matrice_3x3)

                root.mainloop()

            if metodo2x2.collidepoint(mouse_pos):
                root=Tk()
                root.title("Matrice 2x2")
                ...
                Button(root, text="CALCOLA", command=metodo2x2_calcolo, font=('verdana', 15)).place(height=25, x=0, y=400)

                Button(root, text="RESET", command=reset_metodo_2x2, font=('verdana', 15)).place(height=25, x=0, y=425)

                root.bind('<Return>', metodo2x2_calcolo)
                root.bind('<Return>', reset_metodo_2x2)

                root.mainloop()

            if metodo3x3.collidepoint(mouse_pos):
                root=Tk()
                root.title("Matrice 3x3")
                root.geometry("500x500")
                mainframe = ttk.Frame(root)
                ...
                Button(root, text="CALCOLA", command=metodo3x3_calcolo, font=('verdana', 15)).place(height=25, x=0, y=400)

                Button(root, text="RESET", command=reset_metodo_3x3, font=('verdana', 15)).place(height=25, x=0, y=425)

                root.bind('<Return>', metodo3x3_calcolo)
                root.bind('<Return>', reset_metodo_3x3)
